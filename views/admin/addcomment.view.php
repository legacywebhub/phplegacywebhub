...
<div class="col-12 grid-margin stretch-card">
    <div class="card">
    <div class="card-body">
        <h4 class="card-title">Add Comment To Post</h4>
        ...
        <div class="form-group">
            <label>Post ID </label>
            <input type="text" class="form-control" name="post_id" maxlength="10" onkeypress="return onlyNumberKey(event)">
        </div>
        <div class="form-group">
            <label>User ID </label>
            <input type="text" class="form-control" name="user_id" maxlength="10" onkeypress="return onlyNumberKey(event)">
        </div>
        <div class="form-group">
            <label>Name </label>
        ...
        <div class="form-group">
            ...
            <textarea cols="30" rows="15" class="form-control" name="comment" maxlength="1050" required>
            </textarea>
        </div>
