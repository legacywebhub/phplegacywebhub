...
function create_tables() {
    ...
    */
    ...
    $query = "create table if not exists company(
        ...
        facebook_link varchar(60) null,
        instagram_link varchar(60) null,
        x_link varchar(60) null,
        thread_link varchar(60) null,
        youtube_link varchar(60) null,
        linkedin_link varchar(60) null
    ...
    // Services - web design, app development, graphics, real estate, 
    // affiliate marketing, SEO optimization, copy writing, content writing
    ...
    $query = "create table if not exists portfolio_images(
    ...
    $query = "create table if not exists testimonials(
        ...
        client_image varchar(100) null,
        testimony text(300) not null,
    ...
    $query = "create table if not exists properties(
        ...
        title varchar(200) not null,
        description text(10500) not null,
