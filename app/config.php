...
if ($_SERVER["SERVER_NAME"]  == "localhost") {
    ...
    define('DBHOST', "localhost");
    define('DBNAME', "legacywebhub_db");
    define('DBUSER', "legacywebhub_user");
    define('DBPASS', "p@ssword123");

    // HTML BASE PATHS
    define('ROOT', "//legacywebhub.com");
    define('MEDIA_ROOT', ROOT . '/media');
    define('STATIC_ROOT', ROOT . '/assets');

    // EMAIL CONFIG
    define('EMAIL_HOST', "mail.legacywebhub.com");
    define('EMAIL_USERNAME', "support@legacywebhub.com");
